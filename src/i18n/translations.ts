...
const zh: Record<TranslationKey, string> = {
  ...
  'lessons.skip': '跳关',
  'lessons.skipConfirm': '确定花费 {cost} Chill币跳过此关卡？',
...
const en: Record<TranslationKey, string> = {
  ...
  'lessons.skip': 'Skip',
  'lessons.skipConfirm': 'Spend {cost} Chill Coins to skip this level?',
...
const ru: Record<TranslationKey, string> = {
  ...
  'lessons.skip': 'Пропустить',
  'lessons.skipConfirm': 'Потратить {cost} Chill-монет, чтобы пропустить уровень?',
...
const ja: Record<TranslationKey, string> = {
  ...
  'lessons.skip': 'スキップ',
  'lessons.skipConfirm': '{cost} Chillコインを使ってこのレベルをスキップしますか？',
...
const ko: Record<TranslationKey, string> = {
  ...
  'lessons.skip': '건너뛰기',
  'lessons.skipConfirm': '{cost} Chill 코인으로 이 레벨을 건너뛰시겠습니까?',
